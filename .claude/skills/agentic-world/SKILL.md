---
name: agentic-world
description: Set up the local Agentic World MCP in Claude Code on Sepolia, then use it for identity, service authentication, policy, rotation, and revocation.
---

Agentic World runs as a local MCP server. This skill teaches Claude Code how to set it up and use its tools; installing the skill alone does not install the MCP. Treat `agentic-world:init`, `agentic-world:create`, `agentic-world:rotate`, and `agentic-world:revoke` as user prompts, not shell commands.

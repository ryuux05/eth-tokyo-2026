...
The contracts and SDKs do not implement resource authorization, human account matching, payments, or HTTP endpoint conventions. Those are the next service/demo milestone.
